...
export default function FormalGrowerMetricCards({ selectedFilters }: Props) {
  const t = useTranslations("customerManagement.formalGrower.userMetrics");
