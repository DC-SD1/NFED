...
interface Props {
  ...
  options: Option[];
  onValueChange?: (selectedOptions: Option[]) => void;
  error?: string;
  className?: string;
  defaultValues?: string[];
  disabled?: boolean;
  renderValue?: (option?: Option[]) => React.ReactNode;
  renderDropdownItem?: (option: Option) => React.ReactNode;
...
export function MultiTagSelectDropdown({
  className,
  options,
  placeholder,
  searchPlaceholder,
      ...
      <Popover open={open} onOpenChange={setOpen}>
        ...
        >
          ...
          <div className={"mb-4 mr-4 flex justify-end gap-2.5"}>
            ...
            <Button size="sm" onClick={handleAdd} disabled={selectedOptions.length === 0}>
