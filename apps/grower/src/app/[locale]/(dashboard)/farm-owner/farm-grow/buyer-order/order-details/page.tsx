...
import AgriculturalOrderCard from "@/components/dashboard/order-details-cards/order-summary-card";
    ...
    <TopLeftHeaderLayout>
      <div className="px-2 py-6 md:items-center md:justify-center md:px-6 md:pt-0 lg:px-8">
        <div className="mx-auto w-full max-w-lg md:max-w-4xl lg:max-w-2xl">
          ...
          <AgriculturalOrderCard />
          <div className="mt-8 flex items-center justify-center">
            <Button
              variant="default"
              className="w-3/4 rounded-xl"
              onClick={() =>
                router.push("/farm-owner/farm-grow/buyer-order/agreement")
              }
            >
              {t("farm")}
