...
export function GoalsForm() {
  ...
  const {
    ...
    defaultValues: {
      farmingGoal: signUpStore.newbieData?.farmingGoal ?? undefined,
    },
  });
  ...
  const onSubmit = async (data: GoalsData) => {
    signUpStore.setNewbieData({ farmingGoal: data.farmingGoal });
    router.push("/onboarding/newbie/commitment");
  };
