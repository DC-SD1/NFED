...
import { Input, type InputProps } from "@cf/ui";
import { Textarea } from "@cf/ui";
  ...
  return (
    <div
      ...
      className={cn(
        ...
        // Focus state.
        "has-[[data-slot=input-group-control]:focus-visible]:border-primary has-[[data-slot=input-group-control]:focus-visible]:ring has-[[data-slot=input-group-control]:focus-visible]:ring-primary/50",
