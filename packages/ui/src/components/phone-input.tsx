...
const PhoneInput: React.ForwardRefExoticComponent<PhoneInputProps> =
  React.forwardRef<React.ElementRef<typeof RPNInput.default>, PhoneInputProps>(
    (
      { className, onChange, value, disabledCountrySelector, ...props },
      ref,
    ) => {
      return (
        <RPNInput.default
          ...
          countrySelectComponent={(props: CountrySelectProps) => (
            <CountrySelect {...props} disabled={disabledCountrySelector} />
          )}
      ...
      <PopoverTrigger asChild>
        ...
        >
          ...
          <svg
            ...
            className={cn(
              "-mr-2 size-3 opacity-100",
              disabled ? "hidden" : "opacity-100",
            )}
          >
            <path d="M5 6L0 0H10L5 6Z" fill="#1D2939" />
          </svg>
        </Button>
      </PopoverTrigger>
